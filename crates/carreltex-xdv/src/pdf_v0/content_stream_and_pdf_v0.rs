...
fn should_tighten_transition_gap_v7(previous: BodyFlowKindV0, next: BodyFlowKindV0) -> bool {
    ...
    matches!(
        ...
        (BodyFlowKindV0::Paragraph, BodyFlowKindV0::List)
            ...
            | (BodyFlowKindV0::List, BodyFlowKindV0::Table)
            | (BodyFlowKindV0::Table, BodyFlowKindV0::List)
            | (BodyFlowKindV0::Quote, BodyFlowKindV0::Table)
            | (BodyFlowKindV0::Table, BodyFlowKindV0::Quote)
            ...
            | (BodyFlowKindV0::FrontMatter, BodyFlowKindV0::List)
            | (BodyFlowKindV0::FrontMatter, BodyFlowKindV0::Quote)
            | (BodyFlowKindV0::FrontMatter, BodyFlowKindV0::Table)
