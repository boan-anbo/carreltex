...
#[test]
fn braced_accent_passthrough_is_counted_as_literal_char() {
...
#[test]
fn braced_accent_passthrough_accepts_control_symbol_payload() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main = b"\\documentclass{article}\n\\begin{document}\nHello.\\~{\\%}XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
...
#[test]
fn control_symbol_bang_is_noop_and_only_body_chars_are_counted() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main = b"\\documentclass{article}\n\\begin{document}\nHello.\\!XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
...
#[test]
fn control_symbol_semicolon_is_counted_as_space_char() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main = b"\\documentclass{article}\n\\begin{document}\nHello.\\;XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
...
#[test]
fn control_symbol_dollar_keeps_literal_output_with_token_level_char_count() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main = b"\\documentclass{article}\n\\begin{document}\nHello.\\$XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
...
#[test]
fn control_word_textgreater_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textbar_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textbar XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textbraceleft_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textbraceright_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textunderscore_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textquotesingle_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textasciigrave_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textquotedblleft_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textquotedblright_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textendash_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textendash XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textemdash_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textemdash XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textellipsis_is_counted_as_three_literal_chars_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
    ...
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
    assert_eq!(char_count, baseline + 6);
}

#[test]
fn control_word_textbullet_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textbullet XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textdegree_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textdegree XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textdagger_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textdagger XYZ\n\\end{document}\n";
...
#[test]
fn control_word_textdaggerdbl_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textsection_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
...
#[test]
fn control_word_textparagraph_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textparagraph XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_textcopyright_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textcopyright XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_textregistered_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textregistered XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_textordfeminine_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textordfeminine XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_textordmasculine_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textordmasculine XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_textperiodcentered_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\textperiodcentered XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
...
#[test]
fn control_word_texttrademark_is_counted_as_literal_char_and_space_is_swallowed() {
    let baseline = hello_baseline_char_count();
    let mut mount = Mount::default();
    let main =
        b"\\documentclass{article}\n\\begin{document}\nHello.\\texttrademark XYZ\n\\end{document}\n";
    assert!(mount.add_file(b"main.tex", main).is_ok());
    let result = compile_request_v0(&mut mount, &valid_request());
    assert_eq!(result.status, CompileStatus::Ok);
    let char_count = stats_u64_field(&result.tex_stats_json, "char_count").expect("char_count");
