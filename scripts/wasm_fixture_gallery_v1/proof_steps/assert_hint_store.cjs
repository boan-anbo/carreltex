...
const requiredEntries = [
  ...
  ['texmf', 'png', 'figs__demo_graphic.png', 'typeset'],
  ['texmf', 'png', 'plots__demo_graphic.png', 'typeset'],
  ['texmf', 'png', 'figs__banner_graphic.png', 'typeset'],
  ['texmf', 'png', 'figs__sub__banner_graphic.png', 'typeset'],
