...
printf 'fixture-bytes-for-phase2-figs-fixedpoint-graphic-png\n' > "$FIXTURE_SOURCE_DIR/xetex/png/phase2__figs__phase2-fixedpoint-figure.png"
printf 'fixture-bytes-for-phase2-plots-fixedpoint-graphic-png\n' > "$FIXTURE_SOURCE_DIR/xetex/png/phase2__plots__phase2-fixedpoint-figure.png"
...
printf 'fixture-bytes-for-phase2-fixedpoint-refs-bib\n' > "$FIXTURE_SOURCE_DIR/xetex/bib/phase2_fixedpoint_refs.bib"
printf 'fixture-bytes-for-phase2-fixedpoint-more-bib\n' > "$FIXTURE_SOURCE_DIR/xetex/bib/phase2_fixedpoint_more.bib"
...
printf 'fixture-bytes-for-biblatex-sty\n' > "$FIXTURE_SOURCE_DIR/xetex/sty/biblatex.sty"
