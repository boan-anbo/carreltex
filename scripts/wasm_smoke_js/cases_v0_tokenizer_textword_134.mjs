export function runTokenizerTextwordLeaf134Cases(ctx, helpers) {
  const {
    addMountedFile,
    expectOk,
    readCompileLogBytes,
  ...
  compileAndAssertDeltaPlus4('tokenizer control-word-textordfeminine', 'textordfeminine');
  compileAndAssertDeltaPlus4('tokenizer control-word-textordmasculine', 'textordmasculine');
}
