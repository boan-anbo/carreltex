export function runTokenizerTextwordLeaf140Cases(ctx, helpers) {
  const {
    addMountedFile,
  ...
  compileAndAssertDeltaPlus4('tokenizer control-word-textasciimacron', 'textasciimacron');
  compileAndAssertDeltaPlus4('tokenizer control-word-textasciibreve', 'textasciibreve');
  compileAndAssertDeltaPlus4('tokenizer control-word-textasciidieresis', 'textasciidieresis');
  compileAndAssertDeltaPlus4('tokenizer control-word-textasciicaron', 'textasciicaron');
  compileAndAssertDeltaPlus4('tokenizer control-word-textnumero', 'textnumero');
  compileAndAssertDeltaPlus4('tokenizer control-word-textordmhyphen', 'textordmhyphen');
  compileAndAssertDeltaPlus4('tokenizer control-word-textopenbullet', 'textopenbullet');
  compileAndAssertDeltaPlus4('tokenizer control-word-textleaf', 'textleaf');
  compileAndAssertDeltaPlus4('tokenizer control-word-textmusicalnote', 'textmusicalnote');
  compileAndAssertDeltaPlus4('tokenizer control-word-textreferencemark', 'textreferencemark');
}
