export function runTokenizerTextwordLeaf139Cases(ctx, helpers) {
  const {
    addMountedFile,
    expectOk,
    readCompileLogBytes,
  ...
  compileAndAssertDeltaPlus4('tokenizer control-word-textminus', 'textminus');
  compileAndAssertDeltaPlus4('tokenizer control-word-textplus', 'textplus');
  compileAndAssertDeltaPlus4('tokenizer control-word-textequals', 'textequals');
  compileAndAssertDeltaPlus4('tokenizer control-word-textcolon', 'textcolon');
  compileAndAssertDeltaPlus4('tokenizer control-word-textsemicolon', 'textsemicolon');
  compileAndAssertDeltaPlus4('tokenizer control-word-textcomma', 'textcomma');
  compileAndAssertDeltaPlus4('tokenizer control-word-textperiod', 'textperiod');
  compileAndAssertDeltaPlus4('tokenizer control-word-textslash', 'textslash');
  compileAndAssertDeltaPlus4('tokenizer control-word-textparenleft', 'textparenleft');
  compileAndAssertDeltaPlus4('tokenizer control-word-textparenright', 'textparenright');
}
