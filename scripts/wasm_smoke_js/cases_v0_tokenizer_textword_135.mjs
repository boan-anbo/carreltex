export function runTokenizerTextwordLeaf135Cases(ctx, helpers) {
  const {
    addMountedFile,
    expectOk,
    readCompileLogBytes,
  ...
  compileAndAssertDeltaPlus4('tokenizer control-word-textyen', 'textyen');
  compileAndAssertDeltaPlus4('tokenizer control-word-textsterling', 'textsterling');
}
