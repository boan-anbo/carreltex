export function runTokenizerTextwordLeaf133Cases(ctx, helpers) {
  const {
    addMountedFile,
  ...
  compileAndAssertDeltaPlus4('tokenizer control-word-textparagraph', 'textparagraph');
  compileAndAssertDeltaPlus4('tokenizer control-word-textcopyright', 'textcopyright');
  compileAndAssertDeltaPlus4('tokenizer control-word-textregistered', 'textregistered');
}
