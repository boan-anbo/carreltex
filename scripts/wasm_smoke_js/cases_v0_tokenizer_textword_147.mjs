export function runTokenizerTextwordLeaf147Cases(ctx, helpers) {
  const {
    addMountedFile,
  ...
  compileAndAssertDelta('tokenizer control-word-textoneeighth', 'textoneeighth', 6);
  compileAndAssertDelta('tokenizer control-word-textthreeeighths', 'textthreeeighths', 6);
  compileAndAssertDelta('tokenizer control-word-textfiveeighths', 'textfiveeighths', 6);
  compileAndAssertDelta('tokenizer control-word-textseveneighths', 'textseveneighths', 6);
  compileAndAssertDelta('tokenizer control-word-textlnot', 'textlnot', 4);
  compileAndAssertDelta('tokenizer control-word-textbigcircle', 'textbigcircle', 4);
  compileAndAssertDelta('tokenizer control-word-textmarried', 'textmarried', 4);
  compileAndAssertDelta('tokenizer control-word-textdivorced', 'textdivorced', 4);
  compileAndAssertDelta('tokenizer control-word-textopenstar', 'textopenstar', 4);
  compileAndAssertDelta('tokenizer control-word-textborn', 'textborn', 4);
  compileAndAssertDelta('tokenizer control-word-textdied', 'textdied', 4);
  compileAndAssertDelta('tokenizer control-word-texttildelow', 'texttildelow', 4);
  compileAndAssertDelta('tokenizer control-word-textdblhyphen', 'textdblhyphen', 5);
  compileAndAssertDelta('tokenizer control-word-textdiscount', 'textdiscount', 4);
  compileAndAssertDelta('tokenizer control-word-textpilcrow', 'textpilcrow', 4);
}
