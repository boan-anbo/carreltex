...
\subsection{Figure}
The first figure block below is a deterministic placeholder stub with caption spacing invariants.

\begin{figure}
\caption{Deterministic placeholder figure caption for layout validation.}
\end{figure}
This paragraph follows the first figure before introducing a second figure in a later section.

\subsection{Figure References}
Interleaved text between figure blocks keeps figure numbering deterministic across section boundaries.

\begin{figure}
\caption{Second deterministic figure caption to validate figure ordinal and figref resolution.}
\end{figure}
This paragraph follows the second figure after interleaved section text.
